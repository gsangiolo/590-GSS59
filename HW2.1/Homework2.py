...
def minimize(func, init_guess, args, method, tol):
    global_min_value, local_min_value = 1000000, 1000000 # initialize large minimum values
    at_local_minima = False
    while !at_local_minima:
        # Shift current coordinate (param/init_guess values)
        # Calculate SSE
        # Compare to local and global mins
        # If higher than local min, exit and try another path
    return
