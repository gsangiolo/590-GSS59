...
training_idx, val_idx, test_idx = rand_indices[:CUT1], rand_indices[CUT1:CUT2], rand_indices[CUT2:]
...
def plot_0():
        fig, ax = plt.subplots()
        ax.plot(epochs, history_dict['loss'], 'o', label='Training loss')
        ax.plot(epochs, history_dict['val_loss'], 'o', label='Validation loss')
...
def plot_1(xla='x',yla='y'):
        fig, ax = plt.subplots()
        ax.plot(x[training_idx]    , y[training_idx],'o', label='Training')
        ax.plot(x[val_idx]      , y[val_idx],'x', label='Validation')
        ax.plot(x[test_idx]     , y[test_idx],'*', label='Test')
        ax.plot(x[training_idx]    , yp,'.', label='Model')
...
def plot_2(xla='y_data',yla='y_predict'):
        fig, ax = plt.subplots()
        ax.plot(y[training_idx]  , yp,'*', label='Training')
        ax.plot(y[val_idx]    , yp_val,'*', label='Validation')
        ax.plot(y[test_idx]    , yp_test,'*', label='Test')
        plt.xlabel(xla, fontsize=18);   plt.ylabel(yla, fontsize=18);   plt.legend()
        plt.show()
